...
public class ReservasView extends JFrame {
	...
	// Declaración de ReservaController
	...
	public ReservasView() {
		...
		try (Connection connection = ConnectionFactory.getConnection()) {
			...
			ex.printStackTrace();
			JOptionPane.showMessageDialog(null, "Error al crear el controlador de reserva.");
		}
		...
		txtValor.setBounds(78, 328, 255, 33);
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
					...
					String valorDiariaTexto = txtValor.getText();

					try {
						double valorDiaria = Double.parseDouble(valorDiariaTexto);
